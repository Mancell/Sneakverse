...
export default function YouTubeVideoCards({ videos, title = "YouTube" }: YouTubeVideoCardsProps) {
  ...
  return (
    <section id="youtube" className="mt-6 scroll-mt-24">
            ...
            <div key={video.id} className="flex-shrink-0">
              <YouTubeVideoCard 
                ...
                onPlayChange={(playing) => {
                  console.log('[YouTubeVideoCards] Play change:', video.id, playing);
                  if (playing) {
